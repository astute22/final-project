                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="center" id="center" >
                                    	<option value="HEAD_QUARTER">본사</option>
                                    	<option value="CT-SR-S">선릉휴대폰센터</option>
                                    	<option value="CT-GN-S">강남센터</option>
                                    	<option value="CT-NH-S">논현휴대폰센터</option>
                                    	<option value="CT-DG-S">도곡휴대폰센터</option>
                                    	<option value="CT-GD-S">강동센터</option>
                                    	<option value="CT-CH-S">천호휴대폰센터</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
